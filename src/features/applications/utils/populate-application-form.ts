...
export function populateApplicationForm(app: Application): ApplicationEditFormInput {
  ...
  return {
    ...
    ns_migration_status_azure_count: app.ns_migration_status_azure_count ?? "",
    ns_to_migrate_bleu_environment_names: app.ns_to_migrate_bleu_environment_names ?? "",
    ns_migration_status_bleu_count: app.ns_migration_status_bleu_count ?? "",
